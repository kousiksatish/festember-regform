	...
	<html lang="en">
	  ...
	  <div class="starter-template">
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-3">
	        <input type="text" class="form-control" name="idname" placeholder="ID Name" value="<?php echo $row['idname']; ?>" required>
	      </div>
	    </div>
	    <?php
	      $teams = array(
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-3">
	        <input type="text" class="form-control" name="rollno" pattern="[0-9]{9}" title="9 digit rollno" value="<?php echo $row['rollno']; ?>" placeholder="Roll Number" required>
	      </div>
	    </div>
	    <?php 
	      $depts = array(
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-3">
	        <input type="text" class="form-control" name="phoneno" placeholder="Phone Number" pattern="[0-9]{10}" title="10 digit moile no" value="<?php echo $row['phoneno']; ?>"  required>
	      </div>
	    </div>
